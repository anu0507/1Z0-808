...
// R apply(T t);
		...
		Function<Integer, Integer> fun2 = (t) -> {
			return t;
		};
		Function<Integer, Integer> compose1 = fun2.compose(fun1).compose(fun);
		Integer result2 = compose1.apply(50);
		System.out.println(result2);
		Function<String, String> fun3 = (t) -> {
			return t;
		};
		/*
		 * Function<Integer, String> andThen = fun2.andThen(fun); String result3 =
		 * andThen.apply(40); System.out.println(result3);
		 */
